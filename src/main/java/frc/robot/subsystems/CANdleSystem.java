...
public class CANdleSystem extends SubsystemBase {
  ...
  public CANdleSystem() {
    ...
    m_candleChannel = 0;
    // m_toAnimate = new FireAnimation(1, 0.75, LEDS_PER_ANIMATION, 1, 0.3, m_animDirection,
    // m_candleChannel * LEDS_PER_ANIMATION + 8);
    // m_toAnimate = new ColorFlowAnimation(232, 52, 220, 0, 0.7, LEDS_PER_ANIMATION,
    // Direction.Forward, m_candleChannel * LEDS_PER_ANIMATION + 8);
    // m_toAnimate = new RgbFadeAnimation(0.7, 0.4, LEDS_PER_ANIMATION, m_candleChannel *
    // LEDS_PER_ANIMATION + 8);
    // m_toAnimate = new TwinkleAnimation(255, 255, 255, 0, 0.4, LEDS_PER_ANIMATION,
    // TwinklePercent.Percent42, m_candleChannel * LEDS_PER_ANIMATION + 8);
    m_toAnimate =
        new RainbowAnimation(
            1, 1, LEDS_PER_ANIMATION, m_animDirection, m_candleChannel * LEDS_PER_ANIMATION + 8);
  ...
  public void periodic() {
    ...
    if (hasnote == true && hasnoteprevious == false) {
      m_toAnimate =
          new StrobeAnimation(
              0, 0, 255, 0, 0.01, LEDS_PER_ANIMATION, m_candleChannel * LEDS_PER_ANIMATION + 8);
  ...
  public void defense() {
    ...
    m_toAnimate =
        new RainbowAnimation(
            1, 0.7, LEDS_PER_ANIMATION, m_animDirection, m_candleChannel * LEDS_PER_ANIMATION + 8);
  }
  ...
  public void coralintake() {
    ...
    m_toAnimate =
        new StrobeAnimation(
            0, 255, 0, 0, 0.01, LEDS_PER_ANIMATION, m_candleChannel * LEDS_PER_ANIMATION + 8);
  }
  ...
  public void autonomous() {
    ...
    m_toAnimate =
        new StrobeAnimation(
            232, 0, 220, 0, 0.01, LEDS_PER_ANIMATION, m_candleChannel * LEDS_PER_ANIMATION + 8);
  }

  public void algaenet() {
    m_candleChannel = 0;
    m_toAnimate =
        new StrobeAnimation(
            255, 0, 0, 0, 0.01, LEDS_PER_ANIMATION, m_candleChannel * LEDS_PER_ANIMATION + 8);
  }
  ...
  public void algaeintake() {
    ...
    m_toAnimate =
        new StrobeAnimation(
            220, 0, 0, 50, 0.01, LEDS_PER_ANIMATION, m_candleChannel * LEDS_PER_ANIMATION + 8);
  }
}
