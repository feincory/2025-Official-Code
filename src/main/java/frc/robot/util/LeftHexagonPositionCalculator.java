...
public class LeftHexagonPositionCalculator {

  public static class LeftScoringPosition {
    public Translation2d position;
    public Rotation2d rotation;

    public LeftScoringPosition(Translation2d position, Rotation2d rotation) {
  ...
  public static ArrayList<LeftScoringPosition> calculateHexagonPositions(
      double centerblueX,
      double centerblueY,
      double centerredX,
      double centerredY,
    ...
    for (int side = 0; side < 6; side++) {
      ...
      if (side == 6) {
        ...
        if (redside) {
          ...
          positions.add(new LeftScoringPosition(new Translation2d(pos2X, pos2Y), rotation));
        } else {
  ...
  public static LeftScoringPosition findNearestPosition(
      Translation2d currentPosition,
      ArrayList<LeftScoringPosition> positions,
      double reefx,
      double reefy) {
    double minDistance = Double.MAX_VALUE;
    LeftScoringPosition nearestPosition = null;

    for (LeftScoringPosition position : positions) {
