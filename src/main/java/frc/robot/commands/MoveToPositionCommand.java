...
public class MoveToPositionCommand extends SequentialCommandGroup {
  ...
  private static final Map<String, MovementType> movementRules =
      Map.ofEntries(
          ...
          Map.entry("0-9", MovementType.EIFE),
          ...
          Map.entry("1-9", MovementType.FEIFE),
          ...
          Map.entry("6-9", MovementType.PARALLEL),
          ...
          Map.entry("7-9", MovementType.PARALLEL),
